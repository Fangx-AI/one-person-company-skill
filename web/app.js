...
const OPC_SLASH_COMMANDS = [
  {
    ...
    label: "产品判断",
    hint: "竞品、付费机制、工作流",
    prompt: "/产品判断\nidea: 我想做一个 [产品/服务]\ntarget_user: [具体人群]\nworkflow: [具体工作流：用户现在在哪个流程里遇到问题]\npaid_trigger: [用户为什么现在愿意付钱]\n请以商业化可行性为第一准则，先判断能不能收费、能不能低成本触达、能不能持续交付，再给竞品或替代方案、付费机制、风险边界和验证动作。回答必须有信息增量。",
  },
  {
    id: "cases",
    label: "相似案例",
    hint: "对标、路径、风险",
    prompt: "/相似案例\nidea: 我想做一个 [产品/服务]\ntarget_user: [具体人群]\nuse_case: [具体使用场景]\nmarket_hint: [你知道的竞品/替代方案，没有就写不知道]\n请围绕商业化可行性找类似产品或案例，拆它们的用户、付费机制、获客路径、可复制部分、不可复制风险，并说明这些案例给我的信息增量是什么。",
  },
  {
    id: "pricing",
    label: "定价获客",
    hint: "价格、渠道、第一单",
    prompt: "/定价获客\nidea: 我想做一个 [产品/服务]\ntarget_user: [具体人群]\npaid_trigger: [用户愿意付钱的时刻]\nacquisition_channel: [你能触达用户的渠道]\n请以商业化可行性为第一准则，判断能不能收费，给 3 档定价、第一批 20 个用户从哪里来、第一单怎么成交，以及不该继续的停损信号。回答必须有信息增量。",
  },
];
